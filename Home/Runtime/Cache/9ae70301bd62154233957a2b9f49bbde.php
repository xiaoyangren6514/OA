...
<title>联系人管理|<?php echo ($configcache['Title']); ?></title>
...
$(document).ready(function() {
	...
	function Operating() {
		$('#content #table .tr .edit').click(function(event) {
			...
			if (id=='' || isNaN(id)) {
				...
				popload('修改联系人信息',860,430,'__APP__/Client/contactedit/id/'+id);
				addDiv($('#iframe_pop'));
				popclose();
			}
		});
	...
	contactajax('__APP__/Client/contactajax?keyword=');
	var speed='';
	$('.search .text').keyup(function() {
		clearTimeout(speed);
		var value = $(this).val();
		speed = setTimeout(function() {
			contactajax('__APP__/Client/contactajax?keyword='+value);
		},300);
	});
});
</script>
...
<div id="content">
    ...
    <h2>
        ...
        <div class="search">
            ...
            <font>小贴士：输入客户名称或手机号码即可实时搜索</font>
        </div>
    </h2>
    <h3>
    	<a href="__APP__/Client/index">客户资料</a>
    	<a href="__APP__/Client/contact" class="h3a">联系人</a>
